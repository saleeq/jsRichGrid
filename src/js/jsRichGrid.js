(function ($) {
  ...
  $.fn.jsRichGrid = function (options) {
    ...
    for (iCount = 0; iCount < tableStructure.length; iCount++) {
      ...
      var current_td;
      $('.jsRichContainer').on('click', tableTdClass[iCount], function () {
      ...
      $('.jsRichContainer').on('focusout', '.text' + tableTdClass[iCount].substr(1), function () {
        var x,
        y;
      ...
      $('.jsRichContainer').on('change', '.drop' + tableTdClass[iCount].substr(1), function () {
        var x,
        y;
        x = current_td[0].cellIndex;
        y = current_td.parent().index();
    ...
    $('.jsRichContainer').on('click', '.richRowDelete', function () {
